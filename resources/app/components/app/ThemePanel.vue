    ...
    <perfect-scrollbar class="theme-panel-content h-100">
      ...
      <div class="theme-version">
        <div class="theme-version-item">
          <a
            href="https://seantheme.com/color-admin/admin/html/index_v3.html"
            class="theme-version-link active"
          >
            <span
              style="background-image: url(/assets/img/theme/default.jpg)"
              class="theme-version-cover"
            ></span>
          </a>
        </div>
        <div class="theme-version-item">
          <a
            href="https://seantheme.com/color-admin/admin/transparent/index_v3.html"
            class="theme-version-link"
          >
            <span
              style="background-image: url(/assets/img/theme/transparent.jpg)"
              class="theme-version-cover"
            ></span>
          </a>
        </div>
        <div class="theme-version-item">
          <a
            href="https://seantheme.com/color-admin/admin/apple/index_v3.html"
            class="theme-version-link"
          >
            <span
        ...
        <div class="theme-version-item">
          <a
            href="https://seantheme.com/color-admin/admin/material/index_v3.html"
            class="theme-version-link"
          >
            <span
              style="background-image: url(/assets/img/theme/material.jpg)"
              class="theme-version-cover"
            ></span>
          </a>
        </div>
        <div class="theme-version-item">
          <a
            href="https://seantheme.com/color-admin/admin/facebook/index_v3.html"
            class="theme-version-link"
          >
            <span
              style="background-image: url(/assets/img/theme/facebook.jpg)"
              class="theme-version-cover"
            ></span>
          </a>
        </div>
        <div class="theme-version-item">
          <a
            href="https://seantheme.com/color-admin/admin/google/index_v3.html"
            class="theme-version-link"
          >
            <span
      ...
      <div class="theme-version">
        ...
        <div class="theme-version-item">
          ...
          >
            <span
              style="background-image: url(/assets/img/version/angular1x.jpg)"
              class="theme-version-cover"
            ></span>
          </a>
        </div>
        <div class="theme-version-item">
          <a
            href="https://seantheme.com/color-admin/admin/angularjs17/"
            class="theme-version-link"
          >
            <span
              style="background-image: url(/assets/img/version/angular10x.jpg)"
              class="theme-version-cover"
            ></span>
          </a>
        </div>
        <div class="theme-version-item">
          ...
          >
            <span
              style="background-image: url(/assets/img/version/svelte.jpg)"
              class="theme-version-cover"
            ></span>
          </a>
        </div>
        <div class="theme-version-item">
          ...
          >
            <span
              style="background-image: url(/assets/img/version/laravel.jpg)"
              class="theme-version-cover"
            ></span>
          </a>
        </div>
        <div class="theme-version-item">
          ...
          >
            <span
              style="background-image: url(/assets/img/version/django.jpg)"
              class="theme-version-cover"
            ></span>
          </a>
        </div>
        ...
        <div class="theme-version-item">
          ...
          >
            <span
              style="background-image: url(/assets/img/version/reactjs.jpg)"
              class="theme-version-cover"
            ></span>
          </a>
        </div>
        <div class="theme-version-item">
          ...
          >
            <span
              style="background-image: url(/assets/img/version/dotnet.jpg)"
              class="theme-version-cover"
            ></span>
          </a>
        </div>
      ...
      <div class="theme-version">
        ...
        <div class="theme-version-item">
          ...
          >
            <span
              style="background-image: url(/assets/img/theme/e-commerce.jpg)"
              class="theme-version-cover"
            ></span>
          </a>
        </div>
        ...
        <div class="theme-version-item">
          ...
          >
            <span
              style="background-image: url(/assets/img/theme/corporate.jpg)"
              class="theme-version-cover"
            ></span>
          </a>
        </div>
