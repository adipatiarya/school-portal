    ...
    elms.map(function (elm: any) {
      elm.onclick = function (e) {
        ...
        var loopHeight = setInterval(function () {
          var targetMenu: any = document.querySelector(
            "#app-sidebar-float-submenu"
          );
          var targetMenuArrow: any = document.querySelector(
            "#app-sidebar-float-submenu-arrow"
          );
          var targetMenuLine: any = document.querySelector(
            "#app-sidebar-float-submenu-line"
          );
          var targetHeight: any = targetMenu.clientHeight;
          var targetOffset: any = targetMenu.getBoundingClientRect();
          var targetOriTop: any = targetMenu.getAttribute("data-offset-top");
          var targetMenuTop: any = targetMenu.getAttribute(
            "data-menu-offset-top"
          );
          var targetTop: any = targetOffset.top;
          ...
          if (expand) {
            ...
            if (targetHeight > windowHeight) {
              if (floatSubmenuElm) {
                var splitClass: any = "overflow-scroll mh-100vh".split(" ");
      ...
      <div class="menu">
        <div class="menu-profile">
          ...
          >
            ...
            <div class="menu-profile-image overflow-visible">
              <img src="bulk" class="rounded-pill" alt="" />
            </div>
